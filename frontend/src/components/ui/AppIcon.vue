<!--
  AppIcon: 集中管理应用内所有 SVG 图标
  避免在多个组件中重复手写 SVG path

  用法：
    <AppIcon name="audio" :size="20" />
    <AppIcon name="pdf" :size="16" class="custom" />
-->
<template>
  <svg
    :width="size"
    ...
    :class="['app-icon', { 'app-icon-filled': filled }]"
  >
...
const ICONS: Record<IconName, string> = {
  ...
  'export-json': '<polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/>',
  'export-txt':
  ...
  restore:
    '<rect x="8" y="8" width="12" height="12" rx="2" ry="2"/><path d="M16 8V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2"/>',
...
const pathContent = computed(() => ICONS[props.name] || '')
</script>
